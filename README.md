...
### git remote add origin https://github.com/Lazy-coder-java/git-a-beginners-guide (от англ. remote, «удалённый» + add, «добавить») — привяжи локальный репозиторий к удалённому с URL https://github.com/Lazy-coder-java/git-a-beginners-guide;
...
## Клонирование
### git clone git@github.com:Lazy-coder-java/git-a-beginners-guide (от англ. clone, «клон», «копия») — склонируй репозиторий с URL git-a-beginners-guide из аккаунта Lazy-coder-java на мой локальный компьютер.
